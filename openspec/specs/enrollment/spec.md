...
Inscripción a cursos: registrar que un usuario se unió a un curso (al primer acceso),
independiente de su progreso, para distinguir inscrito / activo / completado.
