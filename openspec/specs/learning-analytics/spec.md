...
Learning analytics over existing signals (progress, interaction, performance,
content), with a shared inactivity definition and honest insufficient-data states.
