...
pythonGenerator.forBlock["write_led_screen"] = function (block) {
  var fil = pythonGenerator.valueToCode(
    block,
    "ROW",
    Order.ATOMIC
  );
  var col = pythonGenerator.valueToCode(
    block,
    "COL",
    Order.ATOMIC
  );
  var text = pythonGenerator.valueToCode(
    block,
    "TEXT",
    Order.ATOMIC
  );
...
pythonGenerator.forBlock["led_screen_off"] = function () {
  var code = "robot.lcd.off()\n";
  return code;
};

pythonGenerator.forBlock["led_screen_on"] = function () {
  var code = "robot.lcd.on()\n";
  return code;
};

pythonGenerator.forBlock["led_screen_clear"] = function () {
