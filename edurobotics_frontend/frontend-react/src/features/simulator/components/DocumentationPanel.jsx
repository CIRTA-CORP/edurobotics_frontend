...
const STEPS = [
  {
    ...
    desc: 'Pulsa el botón Iniciar simulador en el panel derecho. El entorno ROS2 + PyBullet se levanta en la nube y el robot UR5e aparece en la vista 3D. La primera carga puede tardar hasta 90 segundos.',
  },
  {
    n: 2,
...
export default function DocumentationPanel() {
  return (
    <div className="w-full h-full overflow-y-auto bg-[#0d0d10] text-[#dcdbe4]">
      <div className="max-w-3xl mx-auto px-8 py-10">

        {/* Header */}
        <div className="mb-10">
          <p className="text-[11px] font-semibold text-[#a5a1ee] uppercase tracking-[0.2em] mb-2">
            Guía rápida
          </p>
          <h1 className="text-3xl font-bold text-[#f4f4f6] mb-2 tracking-tight">
            Cómo usar el simulador
          </h1>
          <p className="text-sm text-[#a1a0ab] leading-relaxed">
            Sigue estos pasos para escribir tu primer programa y ver el robot UR5e moverse en 3D.
          </p>
        </div>
        ...
        <div className="space-y-4 mb-12">
          {STEPS.map((step) => (
            <div
              key={step.n}
              className="group relative bg-[#131316] border border-[#23232a] rounded-xl p-5 hover:border-[#33333c] transition-colors"
            >
              <div className="flex gap-4">
                <div className="shrink-0 w-9 h-9 rounded-lg bg-[#7d79e3]/[0.14] border border-[#7d79e3]/30 flex items-center justify-center">
                  <span className="text-sm font-bold text-[#a5a1ee]">{step.n}</span>
                </div>
                <div className="flex-1 min-w-0">
                  <h3 className="text-base font-semibold text-[#f4f4f6] mb-1">
                    {step.title}
                  </h3>
                  <p className="text-sm text-[#a1a0ab] leading-relaxed">
                    {step.desc}
        ...
        {/* Sample code */}
        <div className="mb-12">
          <h2 className="text-xl font-bold text-[#f4f4f6] mb-1 tracking-tight">
            Ejemplo de código
          </h2>
          <p className="text-sm text-[#a1a0ab] mb-4">
            Copia y pega esto en el editor para mover el robot a una posición inicial.
          </p>
          <pre className="bg-[#0a0a0c] border border-[#23232a] rounded-xl p-5 overflow-x-auto text-xs text-[#dcdbe4] font-mono leading-relaxed">
{SAMPLE_CODE}
          </pre>
        </div>
        ...
        {/* Tips */}
        <div className="mb-8">
          <h2 className="text-xl font-bold text-[#f4f4f6] mb-4 tracking-tight">
            Consejos útiles
          </h2>
          <div className="grid gap-3">
            {TIPS.map((tip, i) => (
              <div
                key={i}
                className="bg-[#131316] border border-[#1c1c22] rounded-lg p-4"
              >
                <h4 className="text-sm font-semibold text-[#f4f4f6] mb-1">{tip.title}</h4>
                <p className="text-xs text-[#a1a0ab] leading-relaxed">{tip.body}</p>
              </div>
            ))}
          </div>
        </div>
        ...
        {/* Footer note */}
        <div className="border-t border-[#23232a] pt-6 mt-10">
          <p className="text-xs text-[#6e6d78] text-center">
